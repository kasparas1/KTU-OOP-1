...
namespace Lab3
{
    ...
    class ReadingnPrinting
    {
        ...
        /// </summary>
        /// <param name="register">Register of players (which holds the container)</param>
        ...
        /// <summary>
        /// Prints the attackers of the team
        /// </summary>
        /// <param name="register"></param>
        public static void PrintAttacker(BasketballRegister register)
        {
            Console.WriteLine(new string('-', 45));
            Console.WriteLine("| {0,10} | {1,-17} | {2, -8} |", "Vardas", "Pavarde", "Ugis");
            Console.WriteLine(new string('-', 45));
            for (int i = 0; i < register.BasketballCount(); i++)
            {
                Basketball basketball = register.GetBasketball(i);
                Console.WriteLine("| {0,10} | {1,-17} | {2,8} |", basketball.Name, basketball.LastName, basketball.Height);
                Console.WriteLine(basketball.CalculateAge());
            }
            Console.WriteLine(new string('-', 45));
        }
        /// <summary>
        ...
        /// <summary>
        /// Prints invted players to .csv file
        /// </summary>
        /// <param name="fileName"></param>
        /// <param name="Basketball"></param>
        public static void PrintInvitedToCSV(string fileName, BasketballRegister Basketball)
        {
